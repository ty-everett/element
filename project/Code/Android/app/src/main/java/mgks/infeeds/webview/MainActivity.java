...
//	static boolean ASWP_MULFILE     = false;    //upload multiple files in webview
    ...
    private static String ASWV_URL      = "https://element.tk/app/android/index.php"; //complete URL of your website or webpage
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asw_view.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture){
                if(ASWP_FUPLOAD) {
                    ...
                    startActivityForResult(Intent.createChooser(i, "Upload a File..."), asw_file_req);
                }
            }
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback,WebChromeClient.FileChooserParams fileChooserParams){
                ...
                if(ASWP_FUPLOAD) {
                    ...
                    chooserIntent.putExtra(Intent.EXTRA_TITLE, "Upload a File...");
		...
		asw_view.addJavascriptInterface(new Android(this), "Android");
	...
	private class Callback extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            Toast.makeText(getApplicationContext(), "Can't connect to Element!", Toast.LENGTH_SHORT).show();
	...
	public boolean check_permission(int permission){
		switch(permission){
			case 1:
				// making it think it always has permision for location
				return true;//ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED;
